...
#define GK_YAW_ADDRESS              (GK_CM33_USERSPACE_PAGE + 28)
#define GK_PITCH_ADDRESS            (GK_CM33_USERSPACE_PAGE + 32)
#define GK_ROLL_ADDRESS             (GK_CM33_USERSPACE_PAGE + 36)
#define GK_JOYSTICK_RAW_ADDRESS     (GK_CM33_USERSPACE_PAGE + 64)
#define GK_JOYSTICKB_RAW_ADDRESS    (GK_CM33_USERSPACE_PAGE + 72)
#define GK_THROTTLE_ADDRESS         (GK_CM33_USERSPACE_PAGE + 80)
#define GK_THROTTLE_RAW_ADDRESS     (GK_CM33_USERSPACE_PAGE + 88)
#define GK_TILT_RAW_ADDRESS         (GK_CM33_USERSPACE_PAGE + 96)
